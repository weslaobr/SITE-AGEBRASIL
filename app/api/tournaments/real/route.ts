...
export async function GET() {
  try {
    ...
    const response = await fetch(
      'https://liquipedia.net/ageofempires/Age_of_Empires_IV/Tournaments',
      {
        headers: {
          'User-Agent':
    ...
    return NextResponse.json(
      {
        ...
        tournaments: getRealisticTournaments(),
      },
      { status: 500 }
    );
  }
...
// Define o formato de retorno (objeto com 3 arrays)
interface TournamentGroups {
  active: any[];
  upcoming: any[];
  completed: any[];
}

function parseLiquipediaTournaments(html: string): TournamentGroups {
  ...
  // Caso não consiga extrair dados reais, retorna mock
  if (rows.length < 10) {
    return getRealisticTournaments();
  }

  // Aqui você poderia implementar o parsing real no futuro
  // Exemplo: extrair dados com regex ou JSDOM, mas por enquanto retorna mock
  return getRealisticTournaments();
}

// ==================== MOCK DE TORNEIOS ====================

function getRealisticTournaments(): TournamentGroups {
  ...
  return {
    active: [
      ...
      },
      {
        ...
        status: 'active',
        bracket_url:
          'https://liquipedia.net/ageofempires/WESLAO/Community_Cup_45',
    ...
    upcoming: [
      {
        ...
        status: 'upcoming',
        registration_url:
          'https://liquipedia.net/ageofempires/Red_Bull_Wololo/Legacy',
      ...
      },
      {
        ...
        status: 'upcoming',
        registration_url:
          'https://liquipedia.net/ageofempires/ESL/Masters_Cup/December_2024',
    ...
    completed: [
      {
        ...
        status: 'completed',
        vod_url:
          'https://youtube.com/playlist?list=worldchamp2024',
        bracket_url:
          'https://liquipedia.net/ageofempires/World_Championship/2024',
